(function(){
    function createEntidades(ctx){
        ...
        function renderHistorialFusionDictacion(asignatura,seccion){
            ...
            if(!grupo?.fusionDesvinculada && !rel?.fusionDesvinculada) return '';
            const historial=Array.isArray(grupo?.fusionHistorial)&&grupo.fusionHistorial.length
                ? grupo.fusionHistorial
                : (Array.isArray(rel?.fusionHistorial)?rel.fusionHistorial:[]);
            ...
            const partes=[
                ...
                (ultimo?.seccionMadreId||rel?.seccionMadreDesvinculadaId)?`Madre anterior: ${nombreSeccion(ultimo?.seccionMadreId||rel?.seccionMadreDesvinculadaId)}`:'',
