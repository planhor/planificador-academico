...
(() => {
    ...
    const PLANHOR_COLORES = ['#d7eef0','#cbe7ef','#dfdcf6','#d5d0ee','#c7e9e5','#dce4ec','#c8d9ea','#d7dfe8','#c7f0ea','#e7e3f6','#d0e8f2'];
    ...
    const PALETAS = {
        Otoño:{
            css:{bg:'#f6f7f9',surface:'#ffffff','surface-alt':'#eef2f5',border:'#d8e0e6','border-light':'#e9eef2',text:'#102840','text-secondary':'#4f6070',accent:'#7050d8','accent-light':'#18a8a0',danger:'#9b3f52',warning:'#8b6b35',success:'#168675','modal-overlay':'rgba(16,40,64,0.42)'},
            colores:PLANHOR_COLORES,
            espColor:PLANHOR_ESP_COLOR
        },
        Invierno:{
            css:{bg:'#f3f7fb',surface:'#fcfeff','surface-alt':'#e8f0f6',border:'#d2dde7','border-light':'#e4ebf2',text:'#102840','text-secondary':'#516375',accent:'#1058a0','accent-light':'#18b0a0',danger:'#934154',warning:'#80713b',success:'#147d72','modal-overlay':'rgba(16,40,64,0.44)'},
            colores:PLANHOR_COLORES,
            espColor:PLANHOR_ESP_COLOR
        },
        Primavera:{
            css:{bg:'#f3f8f8',surface:'#fdffff','surface-alt':'#e6f1f1',border:'#cfdfdf','border-light':'#e2eeee',text:'#102840','text-secondary':'#506767',accent:'#18a8a0','accent-light':'#7050d8',danger:'#964556',warning:'#867139',success:'#12846f','modal-overlay':'rgba(16,40,64,0.4)'},
            colores:PLANHOR_COLORES,
            espColor:PLANHOR_ESP_COLOR
        },
        Verano:{
            css:{bg:'#f5f8fa',surface:'#ffffff','surface-alt':'#e9f0f3',border:'#d3dde3','border-light':'#e5ecef',text:'#102840','text-secondary':'#52636d',accent:'#0888a0','accent-light':'#7050d8',danger:'#984254',warning:'#8b7036',success:'#158174','modal-overlay':'rgba(16,40,64,0.4)'},
            colores:PLANHOR_COLORES,
            espColor:PLANHOR_ESP_COLOR
        }
    };
