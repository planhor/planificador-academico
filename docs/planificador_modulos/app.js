...
(() => {
    ...
    function analizarGestorSecciones(aoa){
        ...
        const clavesFuertes=['periodo','programaCarrera','programaPlan','jornada','nivel','codigoAsignatura','asignatura','idSeccion','seccion','horas','horasPresenciales','horasVirtuales','tipo','modalidadAsignatura'];
