(function(){
    function createPlanificacion(ctx){
        ...
        function actualizarDisponibilidadCelda(cell,dia,bloque){
            const data = getData();
            if(aplicarOcupacionDocenteCelda(cell,dia,bloque)) return;
        ...
        function actualizarCelda(dia,bloque){
            ...
            if(!cell) return;
            cell.classList.remove('planned','linked-plan','fixed-plan','available','unavailable-docente','teacher-busy','teacher-busy-overlay'); cell.style.backgroundColor=''; cell.innerHTML=''; cell.title='';
            const secId=data.sel.seccionId;
