(function(){
    function createReportes(ctx){
        ...
        async function exportarReporte(){
            ...
            const etiquetas={tro2:'TRO2',docenteNN:'DocenteNN',criticas:'Criticas',transversales:'Transversales',softwareSala:'SoftwarePorSala',softwareAsignatura:'SoftwarePorAsignatura',validacionPrevia:'ValidacionPrevia',gruposDictacion:'GruposDictacion',subseccionesAsignatura:'SubseccionesAsignatura',horasNegociacion:'HorasNegociacionAsignatura',calidadHorario:'CalidadHorario',incompletas:'Incompletas',cargaDocente:'CargaDocente',cargaDefendible:'CargaDefendibleDocente',excedidos:'Excedidos',comparativaHomologo:'ComparativaHomologo',conflictos:'Conflictos'};
