(function(){
    function createReportes(ctx){
        ...
        function actualizarReporte(){
            ...
            container.innerHTML = visibles.length ? generarTablaReporte(visibles, columnas) : '<p>No hay datos para este reporte.</p>';
        }
        ...
        async function exportarReporte(){
            ...
            const etiquetas={tro2:'TRO2',docenteNN:'DocenteNN',criticas:'Criticas',transversales:'Transversales',softwareSala:'SoftwarePorSala',softwareAsignatura:'SoftwarePorAsignatura',validacionPrevia:'ValidacionPrevia',gruposDictacion:'GruposDictacion',calidadHorario:'CalidadHorario',incompletas:'Incompletas',cargaDocente:'CargaDocente',excedidos:'Excedidos',comparativaHomologo:'ComparativaHomologo',conflictos:'Conflictos'};
