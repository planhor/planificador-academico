...
(() => {
    ...
    function guardarMemoriaGestor(analisis,nombreArchivo){
        ...
        data.gestorSecciones.filtroAplicacion=filtroCompletoGestor(analisis.registros||[]);
    ...
    function mostrarPreviewGestorSecciones(analisis,nombreArchivo){
            ...
            <div class="gestor-filter-panel">
                <div class="gestor-filter-header">
                    <div>
                        ...
                        <span>La tabla completa e IDs del Gestor quedan guardadas para búsqueda y herencias externas. Este filtro solo decide qué carreras se crean o actualizan en planificación.</span>
                    </div>
        ...
        document.getElementById('btnAplicarPreviewGestor')?.addEventListener('click',()=>{
            ...
            const registrosAplicar=filtrarRegistrosGestor(analisis.registros||[],filtro);
            if(!registrosAplicar.length){
                toast('Selecciona al menos una carrera para aplicar el Gestor','error');
                return;
            }
            const propuestaAplicar=normalizarPropuestaGestor(registrosAplicar);
            ...
            const msg=[
                ...
                '',
                'La memoria de IDs y la tabla completa se conservarán completas para rastrear herencias externas.',
            ...
            pushUndo();
            data.gestorSecciones=normalizarGestorSeccionesData(data.gestorSecciones);
            data.gestorSecciones.filtroAplicacion={cargaId:data.gestorSecciones.ultimaCargaId||'',carreras:filtro.carreras,ts:new Date().toISOString()};
    ...
    function aplicarUltimoGestorDesdePestana(){
        ...
        const propuesta=normalizarPropuestaGestor(registrosAplicar);
        const revision=validarPropuestaGestor(propuesta);
